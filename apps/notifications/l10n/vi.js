OC.L10N.register(
    ...
    "Hello %s": "Xin chào %s",
    "Hello %s,": "Xin chào %s,",
    "New notification for %s": "%n thông báo mới cho %s",
    "You have a new notification for %s": "Bạn có %n thông báo mới cho %s",
    "You can change the frequency of these emails or disable them in the <a href=\"%s\">settings</a>.": "",
