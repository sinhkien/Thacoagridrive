OC.L10N.register(
    ...
    "A file or folder was shared from <strong>another server</strong>": "Một tệp tin hoặc thư mục đã được chia sẻ từ 1 máy chủ khác 1",
    "Files": "Tệp tin",
    "A file or folder has been <strong>shared</strong>": "Một tệp tin hoặc thư mục đã được shared",
    ...
    "Wrong path, file/folder does not exist": "Đường dẫn sai, tệp tin/thư mục không tồn tại",
    ...
    "Download all files": "Tải xuống tất cả các tệp tin",
    ...
    "Reject share": "Từ chối chia sẻ",
    "Restore share": "Khôi phục lượt chia sẻ",
    "Shared": "Chia sẻ",
    "Shared by {ownerDisplayName}": "Được chia sẻ bởi {ownerDisplayName}",
    "Link to a file": "Liên kết đến một tệp tin",
    ...
    "Shares": "Chia sẻ",
    "Overview of shared files.": "Tổng quan về các tệp tin được chia sẻ.",
    ...
    "List of files that are shared with you.": "Danh sách các tệp tin được chia sẻ với bạn.",
    ...
    "List of files that you shared with others.": "Danh sách các tệp tin mà bạn đã chia sẻ với người khác.",
    ...
    "List of files that are shared by link.": "Danh sách các tệp tin được chia sẻ theo liên kết.",
    ...
    "List of unapproved shares.": "Danh sách chia sẻ không được phê duyệt",
    "No pending shares": "Không có chia sẻ đang chờ xử lý",
    ...
    "Note": "Ghi chú",
    "Select or drop files": "Chọn hoặc thả tệp tin",
    "Uploading files": "Đang tải tệp tin lên",
    "Uploaded files:": "Tệp tin đã được tải lên:",
    ...
    "Files and folders you share will show up here": "Tệp tin và thư mục bạn chia sẻ sẽ được hiển thị tại đây.",
