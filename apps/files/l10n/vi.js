OC.L10N.register(
    ...
    "File could not be uploaded": "Không thể tải lên tệp tin",
    ...
    "Could not rename \"{fileName}\", it does not exist any more": "Không thể đổi tên \"{fileName}\", tệp tin không tồn tại",
    ...
    "Could not create file \"{file}\"": "Không thể tạo tệp tin \"{file}\"",
    "Could not create file \"{file}\" because it already exists": "Không thể tạo tệp tin \"{file}\" vì đã có ",
    ...
    "Error deleting file \"{fileName}\".": "Lỗi khi xóa tệp tin \"{fileName}\".",
    ...
    "including %n hidden": "Bao gồm %n ẩn",
    "You do not have permission to upload or create files here": "Bạn không đủ quyền để Tải lên hoặc Tạo tệp tin ở đây",
    "Uploading %n file": "Đang tải lên %n tệp tin",
    "New": "Tạo mới",
    ...
    "\"{name}\" is not an allowed filetype": "\"{name}\" không phải là loại tệp tin được cho phép",
    ...
    "matches \"{filter}\"": "khớp với \"{filter}\"",
    ...
    "List of files and folders.": "Danh sách các tệp tin và thư mục.",
    "This list is not fully rendered for performance reasons. The files will be rendered as you navigate through the list.": "Danh sách này không được hiển thị đầy đủ vì lý do hiệu suất. Các tệp tin sẽ được hiển thị khi bạn điều hướng qua danh sách.",
    "{summaryFile} and {summaryFolder}": "{summaryFile} và {summaryFolder}",
    "File not found": "Không tìm thấy tệp tin",
    "{count} file": "{đếm} tệp",
    "{count} folder": "{đếm} thư mục",
    ...
    "Select file or folder to link to": "Chọn tệp tin hoặc thư mục để liên kết đến",
    ...
    "File cannot be accessed": "Không thể truy cập tệp tin",
    ...
    "You cannot move a file/folder onto itself or into a subfolder of itself": "Bạn không thể di chuyển một tệp tin/thư mục vào chính nó hoặc vào một thư mục con của chính nó",
    "A file or folder with that name already exists in this folder": "Tệp hoặc thư mục có tên đó đã tồn tại trong thư mục này",
    "The files is locked": "Các tệp tin bị khóa",
    ...
    "{folderCount} folder": "thư mục {folderCount}",
    "{fileCount} file": "tệp {fileCount}",
    "1 file and {folderCount} folder": "1 tệp và thư mục {folderCount}",
    "{fileCount} file and 1 folder": "tệp {fileCount} và 1 thư mục",
    "{fileCount} files and {folderCount} folders": "Tệp {fileCount} và thư mục {folderCount}",
    "List of favorites files and folders.": "Danh sách các tệp tin và thư mục yêu thích.",
    ...
    "List of your files and folders.": "Danh sách các tệp tin và thư mục của bạn.",
    "List of recently modified files and folders.": "Danh sách các tệp tin và thư mục được sửa đổi gần đây.",
    "No recently modified files": "Không có tệp tin được sửa đổi gần đây",
    "Files and folders you recently modified will show up here.": "Các tệp tin và thư mục bạn sửa đổi gần đây sẽ hiển thị ở đây.",
    "Toggle %1$s sublist": "Chuyển đổi danh sách phụ %1$s",
    "No entries found in this folder": "Chưa có mục nào trong thư mục",
    "Upload too large": "Tập tin tải lên quá lớn",
    "The files you are trying to upload exceed the maximum size for file uploads on this server.": "Các tệp tin bạn đang tải lên vượt quá kích thước tối đa cho phép trên máy chủ .",
    ...
    "This list is not fully rendered for performances reasons. The files will be rendered as you navigate through the list.": "anh sách này không được hiển thị đầy đủ vì lý do hiệu suất. Các tệp tin sẽ được hiển thị khi bạn điều hướng qua danh sách.",
    "Search for an account": "Tìm kiếm tài khoản",
    "Choose": "Chọn",
    "Deleted files" : "Tệp đã xóa",
    "New text file" : "Tập tin văn bản mới",
    "Add description" : "Thêm mô tả",
    "Sharring" : "Chia sẻ",
    "No files or folders have been deleted yet": "Chưa có tệp tin hoặc thư mục nào bị xóa"	    },
"nplurals=1; plural=0;");
