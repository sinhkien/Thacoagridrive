OC.L10N.register(
    ...
    {
    "restored" : "khôi phục",
    "Deleted files" : "Tệp tin đã xóa",
    "Restore" : "Khôi phục",
    "No deleted files" : "Không có tệp tin bị xóa",
    "Deleted" : "Đã xóa",
    ...
    "This application enables users to restore files that were deleted from the system.": "Ứng dụng này cho phép người dùng khôi phục các tệp tin đã bị xóa khỏi hệ thống.",
    "This application enables users to restore files that were deleted from the system. It displays a list of deleted files in the web interface, and has options to restore those deleted files back to the users file directories or remove them permanently from the system. Restoring a file also restores related file versions, if the versions application is enabled. When a file is deleted from a share, it can be restored in the same manner, though it is no longer shared. By default, these files remain in the trash bin for 30 days.\nTo prevent a user from running out of disk space, the Deleted files app will not utilize more than 50% of the currently available free quota for deleted files. If the deleted files exceed this limit, the app deletes the oldest files until it gets below this limit. More information is available in the Deleted Files documentation.": "Ứng dụng này cho phép người dùng khôi phục các tệp tin đã bị xóa khỏi hệ thống. Nó hiển thị danh sách các tệp đã xóa trong giao diện web và có các tùy chọn để khôi phục các tệp đã xóa đó trở lại thư mục tệp của người dùng hoặc xóa chúng vĩnh viễn khỏi hệ thống. Việc khôi phục tệp cũng khôi phục các phiên bản tệp liên quan nếu ứng dụng phiên bản được bật. Khi một tệp bị xóa khỏi phần chia sẻ, nó có thể được khôi phục theo cách tương tự, mặc dù nó không còn được chia sẻ nữa. Theo mặc định, những tệp này vẫn ở trong thùng rác trong 30 ngày.\nĐể ngăn người dùng hết dung lượng ổ đĩa, ứng dụng Tệp đã xóa sẽ không sử dụng quá 50% hạn ngạch miễn phí hiện có cho các tệp đã xóa. Nếu các tệp đã xóa vượt quá giới hạn này thì ứng dụng sẽ xóa các tệp cũ nhất cho đến khi nó xuống dưới giới hạn này. Thông tin thêm có sẵn trong tài liệu Tệp đã xóa.",
    "Restore": "Khôi phục",
    "List of files that have been deleted.": "Danh sách các tệp tin đã bị xóa.",
    "No deleted files": "Không có tệp tin bị xóa",
    "Files and folders you have deleted will show up here": "Các tệp tin và thư mục bạn đã xóa sẽ hiển thị ở đây",
    "Deleted": "Đã xóa",
    "You will be able to recover deleted files from here": "Bạn có thể phục hồi các file đã bị xóa từ đây",
    "No entries found in this folder": "Chưa có mục nào trong thư mục",
    "Select all": "Chọn tất cả",
    ...
    "Error while restoring files from trash bin": "Lỗi khi khôi phục tệp tin từ thùng rác",
    "Error while emptying trash bin": "Lỗi khi dọn thùng rác",
    "Error while removing files from trash bin": "Lỗi khi xóa tệp tin khỏi thùng rác",
    "This operation is forbidden": "Thao tác bị cấm",
    "This directory is unavailable, please check the logs or contact the administrator": "Thư mục này không sẵn có, hãy kiểm tra log hoặc liên hệ người quản lý",
    "Delete" : "Xóa"
},
