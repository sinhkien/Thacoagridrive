OC.L10N.register(
    ...
    "The uploaded file exceeds the upload_max_filesize directive in php.ini" : "Tệp tin tải lên đã vượt quá upload_max_filesize giới hạn trong php.in",
    ...
    "Office is a powerful Collabora Online based online office suite with collaborative editing, which supports all major documents, spreadsheet and presentation file formats and works together with all modern browsers." : "Office lả một bộ ứng dụng văn phòng trực tuyến mạnh mẽ dựa trên Collabora Online với khả năng hỗ trợ tính năng cộng tác chỉnh sửa (bạn và bạn bè có thể thao tác đồng thời trên cùng một tài liệu tại cùng một thời điểm), hỗ trợ hầu hết các loại định dạng tài liệu, bảng tính và tệp trình chiếu cũng như tương thích với mọi trình duyệt mới hiện nay.",
    ...
    "The settings only apply to compatible office files that are opened in Office" : "Thiết lập này chỉ áp dụng cho những tệp tương thích khi được mở bằng Office",
    "The following options within Office will be disabled: Copy, Download, Export, Print" : "Các chức năng sau sẽ bị tắt trong Office: Sao chép (Copy), Tải xuống (Download), Xuất (Export), In (Print)",
