OC.L10N.register(
    ...
    "%n app has an update available": "%n ứng dụng có sẵn bản cập nhật",
    ...
    "productName} Talk for iOS": "",
    "productName} Talk for Android": "",
    ...
    "The PHP POSIX extension is required. See linkstart}PHP documentationlinkend} for more details.": "Cần có phần mở rộng PHP POSIX. Xem linkstart}tài liệu PHPlinkend} để biết thêm chi tiết.",
    ...
    "userCount} user …": "userCount} người dùng…",
    "userCount} user": "userCount} người dùng",
    ...
    "Please double check the <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%1$s\">installation guides ↗</a>, and check for any errors or warnings in the <a href=\"%2$s\">log</a>.": "",
    "Check the security of your Nextcloud over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>.": "",
    ...
    "Reasons to use Nextcloud in your organization": "",
    "Developed by the communityopen}Nextcloud communitylinkclose}, the githubopen}source codelinkclose} is licensed under the licenseopen}AGPLlinkclose}.": "",
    ...
    "If you use third party applications to connect to Nextcloud, please make sure to create and configure an app password for each before enabling second factor authentication.": "",
    ...
    "To run this you need the PHP POSIX extension. See linkstart}PHP documentationlinkend} for more details.": "Để chạy cái này, bạn cần có phần mở rộng POSIX của PHP. Xem linkstart}tài liệu PHPlinkend} để biết thêm chi tiết.",
