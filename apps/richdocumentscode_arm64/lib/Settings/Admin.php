...
class Admin implements ISettings
{
    ...
    public function getForm()
    {
        ...
        $absoluteUrlAppInstall = $urlGenerator->getAbsoluteURL('/index.php/settings/apps/app-bundles/richdocumentscode_arm64');
        ...
        return new TemplateResponse('richdocumentscode_arm64', 'admin', $parameters);
    }
    ...
    {
        return 'richdocumentscode_arm64';
    }
