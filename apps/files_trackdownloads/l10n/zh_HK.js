OC.L10N.register(
    ...
    "Downloaded by {actor} (via app)" : "已被 {actor} 下載（透過應用程式）",
    ...
    "Shared file {file} was downloaded by {actor} via the mobile app" : "共享文件 {file} 由 {actor} 透過應用程式下載",
    ...
    "Creates activities for downloads of files that were shared with other users or a group" : "建立與其他用戶或群組共用的檔案下載活動紀錄"
},
"nplurals=1; plural=0;");
