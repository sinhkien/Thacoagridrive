OC.L10N.register(
    ...
    {
    "Downloaded by {actor} (via desktop)" : "{actor} prejme predmet (prek namiznega odjemalca)",
    "Downloaded by {actor} (via app)" : "{actor} prejme predmet (prek prenosne naprave)",
    "Downloaded by {actor} (via browser)" : "{actor} prejme predmet (prek spletnega brskalnika)",
    "Shared file {file} was downloaded by {actor} via the desktop client" : "{actor} prejme dokument {file} v skupni rabi prek namiznega odjemalca.",
