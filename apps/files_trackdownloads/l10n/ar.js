OC.L10N.register(
    ...
    {
    "Downloaded by {actor} (via desktop)" : "تم التنزيل من قبل {actor} (عبر سطح المكتب)",
    "Downloaded by {actor} (via app)" : "تم التنزيل من قبل {actor} (عبر تطبيق)",
    "Downloaded by {actor} (via browser)" : "تم تنزيل من قبل {actor} (عبر المتصفح)",
    "Shared file {file} was downloaded by {actor} via the desktop client" : "تم تنزيل الملف المشترك {file} بواسطة {actor} عبر تطبيق سطح المكتب",
